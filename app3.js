...
web3.eth.getBlockNumber()
	.then(num => { 
		...
		contractBAT.getPastEvents(
			"Transfer", 
			{ 
				filter: { _to: "0x3cD751E6b0078Be393132286c442345e5DC49699" },
				fromBlock: num, 
				toBlock: 'latest'
			}
		).then(events => console.log(events))
